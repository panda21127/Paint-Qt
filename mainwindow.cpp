...
void MainWindow::createActions(){
    ...
    connect(clearScreenAct,SIGNAL(triggered()),scribbleArea,SLOT(penWidth()));
...
void MainWindow::createMenu(){
    ...
    helpMenu = new QMenu(tr("&File"),this);
...
bool MainWindow::maybeSave(){
    if(scribbleArea->isModified()){
        ...
        ret = QMessageBox::warning(this,tr("Scribble"),tr("The image has been modified.\n"
                                                          "Do you want to save your changs?"),
...
bool MainWindow::saveFile(const QByteArray &fileFormat){
    ...
    QString fileName = QFileDialog::getSaveFileName(this,tr("Save As"),initialPath,tr("%1 Fiels (*.%2);; All Files(*)")
